			...
			<div class="container">
				<div class="row">
					<div class="col-sm-12 col-md-12 col-xs-12 col-lg-6 mb--30 mb-lg--0">
						<!-- Login Form s-->
						<?php echo form_open('registerCustomer'); ?>
							<div class="login-form">
								...
								<div class="row">
									...
									<div class="col-12 mb--20">
										...
										<input class="mb-0 form-control" type="email" id="email" placeholder="Enter Your Email Address Here.." name="email" required>
									</div>
									<div class="col-lg-6 mb--20">
										<label for="password">Password</label>
										<input class="mb-0 form-control" type="password" id="password" placeholder="Enter your password" name="password" required>
									</div>
									<div class="col-lg-6 mb--20">
									...
									<div class="col-md-12">
										<input type="submit"  class="btn btn-outlined" value="Register"/>
									</div>
								</div>
							</div>
						</form>
					...
					<div class="col-sm-12 col-md-12 col-lg-6 col-xs-12">
						<?php echo form_open('loginCustomer'); ?>
							<div class="login-form">
								...
								<div class="row">
									...
									<div class="col-12 mb--20">
										<label for="password">Password</label>
										<input class="mb-0 form-control" type="password" id="login-password" placeholder="Enter your password" name="password" required>
									</div>
									<div class="col-md-12">
