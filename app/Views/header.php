...
<html lang="zxx">
    ...
    <!-- Mirrored from htmldemo.net/pustok/pustok/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 26 Nov 2025 08:47:29 GMT -->
    <head>
        <meta charset="utf-8" />
    ...
    <body>
        <div class="site-wrapper" id="top">
            <div class="site-header d-none d-lg-block" style="background-color: gainsboro;">
                            ...
                            <div class="col-lg-3">
                                <div class="header-phone ">
                                    ...
                                    <div class="text">
                                        ...
                                        <p class="font-weight-bold number">+91 8400645735</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="main-navigation flex-lg-right">
                                    <ul class="main-menu menu-right ">
                                        ...
                                        <li class="menu-item has-children">
                                            <a href="javascript:void(0)">About US <i
                                                    class="fas fa-chevron-down dropdown-arrow"></i></a>
                                            <ul class="sub-menu">
                                                <li> <a href="/about">About</a></li>
                                                <li> <a href="/privacy">Privacy Policyy</a></li>
                                        ...
                                        <li class="menu-item has-children">
                                            <a href="javascript:void(0)">ePaper <i
                                                    class="fas fa-chevron-down dropdown-arrow"></i></a>
                                            <ul class="sub-menu">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-5">
                                <div class="header-search-block">
                                    <input type="text" placeholder="Search magazine & Books">
 ...
 //print_r($session->get('id'));
                                            if($session->has('userdata')){?>
                                             <a href="/dashboard" class="font-weight-bold">My Account</a> 
                        ...
                        <div class="col-lg-8">
                            <div class="main-navigation flex-lg-right">
                                <ul class="main-menu menu-right ">
                                    ...
                                    <li class="menu-item has-children">
                                        <a href="javascript:void(0)">eMagazine <i
                                                class="fas fa-chevron-down dropdown-arrow"></i></a>
                                        <ul class="sub-menu">
                                            <li><a href="/magzine">Magazine</a></li>
                                            <li><a href="/detail">Books</a></li>
                                        </ul>
                                    </li>
