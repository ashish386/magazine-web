              ...
              "focusOnSelect": true
                    ...
                    <div class="col-lg-7">
                        <div class="product-details-info pl-lg--30 ">
                            <p class="tag-block">Tags: <a href="#">eMagazine</a>, <a href="#">Books</a></p>
                            <h3 class="product-title"><?php echo $product->title; ?></h3>
                              <p><?php echo $product->short_description; ?></p>
                            <div class="price-block">
                                <span class="price-new">Rs <?php echo $product->special_price; ?>/-</span>
                                <del class="price-old">Rs <?php echo $product->price; ?>/-</del>
                            </div>
...
<!--                            <article class="product-details-article">
                            ...
                            <div class="add-to-cart-row">
                                ...
                                <div class="add-cart-btn">
                                    <a href="/checkout/<?php echo $product->id; ?>" class="btn btn-outlined--primary"><span class="plus-icon">+</span>Buy Now</a>
                                </div>
                            </div>
